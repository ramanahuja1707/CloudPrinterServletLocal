...
<script>
	function validateForm() {
		var loginId = document.forms["myForm"]["clientLocation"].value;
		var emailId = document.forms["myForm"]["clientKey"].value;
		var password = document.forms["myForm"]["adminKey"].value;
		if (clientLocation == null || clientLocation == "") {
			alert("Client Location must be filled out");
			return false;
		}
		if (clientKey == null || clientKey == "") {
			alert("Client Key must be filled out");
			return false;
		}
		if (adminKey == null || adminKey == "") {
			alert("Admin Key must be filled out");
			return false;
		}
	}
</script>
...
<body>
	<div
		...
		<div class="banner">
				...
				class="logo" /></a><div class="bannertext">Cloud Printing</div>
			<div class="menu">
		...
		<div class="main">
			...
			<div class="main2">
				...
				<div
					...
					<p>
					<form action="clientRegistration" name="myForm" method="post"
						onsubmit="return validateForm()">
						<div class="name">
							Client Location: <select name="clientLocation">
						...
						<div class="name">
							Client Key:<input name="clientKey" type="password"
								style="float: right; width: 60%; border-radius: 5px; border: 1px solid #e4e4e4; text-align: left;" />
						</div>
						<div class="name">
							Admin Key:<input name="adminKey" type="password"
								style="float: right; width: 60%; border-radius: 5px; border: 1px solid #e4e4e4; text-align: left;" />
						</div>
						<div class="submit_btn">
							<input type="submit" value="submit" /> <br>
					...
					<%
						if (request.getAttribute("clientRegistrationError") != null) {
					%><p style="color: red;"><%=request.getAttribute("clientRegistrationError")%></p>
					<%
						}
					%>
