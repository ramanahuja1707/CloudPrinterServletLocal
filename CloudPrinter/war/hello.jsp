...
<body>
	...
	<center>
		<form action="registeruser" method="post">
			Name :<input type="text" name="userName" /><br> <br> Login
			Id :<input type="text" name="loginId" /><br> <br> Age :<input
				type="text" name="age" /><br> <br> Male :<input
			...
			User Contact No. :<input type="text" name="contactNo" /><br> <br>
