...
<title>Cloud Print HMRITM</title>
		...
		<div class="main">
			...
			<div class="main2">
				...
				<div
					...
					<p>
						<b><i><font size="4px" style="color: #84D7FD;">FORGOT
									LOGIN ID</font></i></b> <br /> <br />
					<form action="forgotloginid" method="post" name="myForm1"
						...
						<br>
						<div class="submit_btn">
							<input type="submit" value="Get Login Id" />
						</div>
					</form>

					<b><font size="4px" style="color: #84D7FD;"></font></b>
					<%
						if (request.getAttribute("forgotLoginIdStatus") != null) {
					%>

					<p style="color: red; font: italic; font-family: sans-serif;"><%=request.getAttribute("forgotLoginIdStatus")%></p>
					<%
						}
					%>
					</p>
